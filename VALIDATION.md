...
RUN testEverySynonymNamesARealIngredient
RUN testAnUnknownIngredientIsShownRatherThanCrashing
RUN testAFileWhoseOwnDishNamesAMissingIngredientIsRefused
RUN testScanSuggestionIgnoresAmountsNobodyConfirmed
RUN testAShelfPointingAtANothingIsStillReachable
RUN testNamesNeverGoBlank
RUN testTheSameChangeIsHeardInEnglishAndInMandarin
RUN testSayingYouHaveItTicksTheLineOffAndMovesItDown
RUN testAmountsAreReadInBothLanguagesAndConvertedToTheKitchensUnits
RUN testANamedDishReplacesTheMealThatWasNamedWithIt
RUN testAnUnclearDishIsAQuestionAndAnUnknownOneIsAdmitted
RUN testABreakfastDishCannotTakeADinnerPlace
RUN testRunningOutAndBuyingMatchTappingTheListByHand
RUN testASentenceThatIsNotAboutThisKitchenChangesNothing
RUN testEverySuggestedSentenceActuallyWorks
...
PASS testEverySynonymNamesARealIngredient
PASS testAnUnknownIngredientIsShownRatherThanCrashing
PASS testAFileWhoseOwnDishNamesAMissingIngredientIsRefused
PASS testScanSuggestionIgnoresAmountsNobodyConfirmed
PASS testAShelfPointingAtANothingIsStillReachable
PASS testNamesNeverGoBlank
PASS testTheSameChangeIsHeardInEnglishAndInMandarin
PASS testSayingYouHaveItTicksTheLineOffAndMovesItDown
PASS testAmountsAreReadInBothLanguagesAndConvertedToTheKitchensUnits
PASS testANamedDishReplacesTheMealThatWasNamedWithIt
PASS testAnUnclearDishIsAQuestionAndAnUnknownOneIsAdmitted
PASS testABreakfastDishCannotTakeADinnerPlace
PASS testRunningOutAndBuyingMatchTappingTheListByHand
PASS testASentenceThatIsNotAboutThisKitchenChangesNothing
PASS testEverySuggestedSentenceActuallyWorks
