...
sources=['FamilyTable/FamilyTableApp.swift','FamilyTable/PantryViews.swift','FamilyTable/Brand.swift','FamilyTable/HistoryView.swift','Sources/FamilyCore/Models.swift','Sources/FamilyCore/Catalog.swift','Sources/FamilyCore/Nutrition.swift','Sources/FamilyCore/Dietary.swift','Sources/FamilyCore/Seasons.swift','Sources/FamilyCore/StepsEN.swift']
refs=[]; builds=[]
for file in sources:
...
uiConfigs=[]
for mode in ['Debug','Release']:
    uiConfigs.append(obj('ui'+mode,'isa = XCBuildConfiguration; buildSettings = { '+base+' GENERATE_INFOPLIST_FILE = YES; CODE_SIGN_STYLE = Automatic; PRODUCT_BUNDLE_IDENTIFIER = com.familykitchen.app.uitests; PRODUCT_NAME = "$(TARGET_NAME)"; TEST_TARGET_NAME = FamilyTable; TARGETED_DEVICE_FAMILY = 1; }; name = '+mode+';'))
