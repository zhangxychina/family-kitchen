...
uiConfigs=[]
for mode in ['Debug','Release']:
    uiConfigs.append(obj('ui'+mode,'isa = XCBuildConfiguration; buildSettings = { '+base+' GENERATE_INFOPLIST_FILE = YES; CODE_SIGN_STYLE = Automatic; PRODUCT_BUNDLE_IDENTIFIER = com.zhangxychina.familykitchen.uitests; PRODUCT_NAME = "$(TARGET_NAME)"; TEST_TARGET_NAME = FamilyKitchen; TARGETED_DEVICE_FAMILY = 1; }; name = '+mode+';'))
